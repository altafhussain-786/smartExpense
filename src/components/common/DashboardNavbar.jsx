...
const DashboardNavbar = () => {
    ...
    return <div className="w-full bg-white px-6 py-3 flex items-center justify-between border-b">
        <div className="flex items-center w-[400px] bg-gray-100 rounded-full px-4 py-2 border border-orange-200 focus-within:ring-2 focus-within:ring-orange-300 transition">
